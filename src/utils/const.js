export const orderStatusMapper = {
  VIETTEL_POST: {
    ...
    504: "Hoàn thành công - Chuyển trả người gửi",
    505: "Phát thất bại - Yêu cầu chuyển chuyển hoàn",
    506: "Phát thất bại",
...
export const specialType = [
  { value: 0, label: '文件类' },
  { value: 1, label: '电子产品类(包括家用电器)' },
  { value: 2, label: '办公用品类, 服装鞋帽，箱包类' },
  { value: 3, label: '化妆品，美容产品类' },
  { value: 4, label: '珠宝，手表，眼镜，贵重饰品类' },
  { value: 5, label: '食品，保健药品类' },
  { value: 6, label: '工艺品类(包括瓷器，茶具，烹饪用品)' },
  { value: 7, label: '玩具乐器类' },
  { value: 8, label: '其他类' },
]
